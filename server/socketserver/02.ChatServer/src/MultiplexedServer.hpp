...
#ifndef STUDY_MULTIPLEXEDSERVER_HPP
#define STUDY_MULTIPLEXEDSERVER_HPP


class MultiplexedServer {
public:
	MultiplexedServer() = default;
	~MultiplexedServer() = default;
...
#endif //STUDY_MULTIPLEXEDSERVER_HPP
